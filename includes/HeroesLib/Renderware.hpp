...
RwFrame* __cdecl RwFrameUpdateObjects(RwFrame* a1);
int __cdecl RwFrameScale(RwFrame* frame, const RwV3d* scale, RwOpCombineType combineOp);
RwFrame* __cdecl RwFrameTranslate(RwFrame* frame, const RwV3d* translation, RwOpCombineType combineOp);
